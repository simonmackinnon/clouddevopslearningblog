...
I run more side projects than one person has any business maintaining — [Kids Code Realm](https://coderealm.theclouddevopslearningblog.com), [TypeStar](https://typestar.theclouddevopslearningblog.com), [Breweries Near Me](https://breweriesnearme.theclouddevopslearningblog.com), [StoryReads](https://bedtime.theclouddevopslearningblog.com), plus this blog. For a while my process for all of them was the same: open the repo, tell Claude Code what I wanted in a paragraph, watch it write code, review the diff, ship it. That works fine for small changes. It falls apart the moment a feature needs more than one sitting, or I come back three days later and can't remember what "add the readiness check thing" was supposed to mean.
